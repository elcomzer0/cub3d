...
/**
 * Applies shading to a wall based on the distance from the player and the wall's orientation.
 *
 * This function calculates a shading factor based on the perpendicular distance to the wall and the wall's orientation
 * (vertical or horizontal, and the direction the wall is facing). The shading factor is used to adjust the color of the
 * wall when rendering. Side is 0 for vertical walls and 1 for horizontal walls. 
 * @param data The main data structure containing the game state.
 * @param shading_factor The initial shading factor, which will be adjusted by this function.
 ...
 * color value with the red, green, and blue components adjusted based on the
 * shading factor.
 *
