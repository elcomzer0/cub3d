...
/*   Updated: 2024/09/07 19:55:21 by jorgonca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * The step values determine the direction the ray moves (left/right, up/down) in the map grid.
 * The side distance values determine how far the ray has to travel to reach the next grid line.
 *
 * @param data A pointer to the main data struct containing the ray casting information.
 */
