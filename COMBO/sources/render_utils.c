...
/*   Updated: 2024/09/06 23:46:30 by jorgonca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * This function checks if the given coordinates are within the bounds of the texture,
 * and if so, it retrieves the color of the pixel at those coordinates. The function
 ...
 * @param texture_index The index of the texture to retrieve the pixel from.
 * @return The color of the pixel at the specified coordinates, or 0 if the coordinates are out of bounds.
 */
 ...
 *
 * This function takes a wall type value and returns the corresponding texture index.
 ...
 *
 * This function takes a floating-point number `x` and returns the largest integer
 * that is less than or equal to `x`. If `x` is already an integer, the function
 * simply returns `x`.
 *
