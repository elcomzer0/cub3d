...
/*   Updated: 2024/09/08 16:24:22 by miturk           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void fill_values(t_data *data, char *line)
{
    ...
    while (i < data->map_width)
    {
        ...
        // {
        //    // Use -1 or any other special value to denote the player's position
        //     data->player_x = i;
...
// dx and dy needs to be initialized here
		...
		else if (line[i] == 'S')
		{
			...
			data->raycast->plane[1] = 0;
			printf("data->player->dx: %f\n", data->player->dx);
			printf("data->player->dy: %f\n", data->player->dy);
